...
<div class="col-sm-9 col-sm-offset-3 col-md-9 col-md-offset-3 col-lg-10 col-lg-offset-2 main">
                <h1 class="sub-header">Kullanıcı Düzenle</h1>
                <form action="{{route('kullanici.duzenle',['id'=>$data->id])}}" method="post">
                    @if($errors->any())
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{old('name',$data->name)}}" class="form-control" id="address" placeholder="Name">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-select form-control" name="yoneticimi" aria-label="Default select example">
                                  ...
                                  <option value="0" @if(old('yoneticimi',$data->yoneticimi)==0) selected @endif>Hayır</option>
                                  <option value="1" @if(old('yoneticimi',$data->yoneticimi)==1)  selected @endif>Evet</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-select form-control" name="isAktive" aria-label="Default select example">
                                  ...
                                  <option value="0" @if(old('isAktive',$data->isAktive)==0) selected @endif>Hayır</option>
                                  <option value="1"  @if(old('isAktive',$data->isAktive)==1) selected @endif>Evet</option>
                                </select>
                            </div>
                        </div>
